package com.example.zhanglulu.coolweatherdemo;
...
import com.example.zhanglulu.coolweatherdemo.service.AutoUpdateService;
import com.example.zhanglulu.coolweatherdemo.service.Delivery;
import com.example.zhanglulu.coolweatherdemo.util.HttpUtil;
import com.example.zhanglulu.coolweatherdemo.util.Utility;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeatherInfo(final String weatherId) {
        ...
        HeWeather.getSearch(this, "haer", "CN", 10, Lang.CHINESE_SIMPLIFIED, new HeWeather.OnResultSearchBeansListener() {
            @Override
            public void onError(Throwable throwable) {
                throwable.printStackTrace();
            }
